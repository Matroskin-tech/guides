# 30 самых популярных вопросов по SQL с собеседований и ответы на них
...
Нормализация отношений в SQL призвана  [организовать информацию в базе данных](sql-nf-schema-guide.md)  таким образом, чтобы она не занимала много места и с ней было удобно работать. Это удаление избыточных данных, устранение дублей, идентификация наборов связанных данных через  `PRIMARY KEY`, etc.
